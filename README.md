...
- [Prova controlada de vídeo](docs/PROVA_VIDEO_CONTROLADA.md)
- [Estudo de vídeo de baixo custo](docs/ESTUDO_VIDEO_BAIXO_CUSTO.md)
- [Spike de processamento de vídeo](docs/VIDEO_PROCESSING_SPIKE.md)
